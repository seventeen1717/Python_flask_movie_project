...
/*评论*/
insert into comment(movie_id,user_id,content,addtime) values(5,1,"好看",now());
insert into comment(movie_id,user_id,content,addtime) values(5,2,"不错",now());
...
insert into comment(movie_id,user_id,content,addtime) values(6,5,"难看",now());
insert into comment(movie_id,user_id,content,addtime) values(6,6,"无聊",now());
insert into comment(movie_id,user_id,content,addtime) values(6,7,"乏味",now());
insert into comment(movie_id,user_id,content,addtime) values(6,8,"无感",now());
...
insert into moviecol(movie_id,user_id,addtime) values(6,5,now());
insert into moviecol(movie_id,user_id,addtime) values(6,6,now());
insert into moviecol(movie_id,user_id,addtime) values(6,7,now());
insert into moviecol(movie_id,user_id,addtime) values(6,8,now());
